...
/**
 * LIVE NAV adapter for Franklin Templeton (BENJI). Reuses the same `FRANKLIN_API_BASE_URL`/
 * `FRANKLIN_API_KEY` env vars `services/issuer-gateway`'s live `FranklinAdapter` already
 ...
 */
export class FranklinNavAdapter implements IssuerNavAdapter {
